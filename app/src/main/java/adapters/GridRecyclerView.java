...
public class GridRecyclerView extends RecyclerView {
    ...
    /* Credit : https://github.com/patrick-iv for
     This class simply makes possible making Grid Layout Animations
     It was used because by default, the RecyclerView doesn’t know if it
     should apply AnimationParameters for a list or a grid
    */
